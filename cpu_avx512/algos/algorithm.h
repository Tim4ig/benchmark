#ifndef CPU_AVX512_ALGOS_ALGORITHM_H_
#define CPU_AVX512_ALGOS_ALGORITHM_H_
...
namespace bench
{
  namespace cpu_avx512
  {
    ...
    {
      const auto timing =
          bench::measure_ms(static_cast<i32>(options.repeats), std::forward<Fn>(fn));
      BenchResult result{};
      result.status = 0;
...
#endif  // CPU_AVX512_ALGOS_ALGORITHM_H_
